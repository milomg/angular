...
export type InjectorTreeD3Node = d3.HierarchyPointNode<SignalTreeNode>;
...
export class InjectorTreeVisualizer extends GraphRenderer<SignalTreeNode, InjectorTreeD3Node> {
